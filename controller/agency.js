...
const Brand_detail = require("../models/agencyModel");
const Plans_detail=require("../models/plans.Model")
module.exports = {
    //agency Login api...
    AgencyLogin: async (req, res) => {
        try {
    ...
    //Agency reset Password api...
    resetAgencysPassword: async (req, res) => {
        try {
    ...
    UpdateData:async(req,res)=>{
        try{
            ...
            const updateRecord= await Brand_detail.findOne({Agency_name:BrandName}).updateOne({
                $set:{
    ...
    showUpdatedData: async (req, res) => {
        try {
            const BrandName = req.params.BrandName;
            const updateRecord = await Brand_detail.findOne({ Agency_name: BrandName })
    ...
    //api for getting Agency detail
    GetAgencyDetail:async(req,res)=>{
        try{
            const Brand_name=req.params.Brand_name
            const Detail=await Brand_detail.findOne({Agency_name:Brand_name});
            if(Detail){
